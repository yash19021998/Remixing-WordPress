...
function Post({ post }) {
  var _a;
  const title = ((_a = post == null ? void 0 : post.title) == null ? void 0 : _a.rendered) || "No title available";
  ...
  }, title), /* @__PURE__ */ React.createElement("p", null, new Date(post.date).toLocaleDateString()))));
}
...
//# sourceMappingURL=/build/routes/index-4IKCYIZG.js.map
